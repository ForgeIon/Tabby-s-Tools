...
public class MachineBlockBlock extends KurosToolsModElements.ModElement {
	@ObjectHolder("kuros_tools:machine_block")
	public static final Block block = null;

	public MachineBlockBlock(KurosToolsModElements instance) {
		super(instance, 75);
	}
