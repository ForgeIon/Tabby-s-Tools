...
import net.mcreator.kurostools.procedures.PsilocybinUsageProcedure;
...
public class PsilocybinItem extends KurosToolsModElements.ModElement {
	@ObjectHolder("kuros_tools:psilocybin")
	public static final Item block = null;

	public PsilocybinItem(KurosToolsModElements instance) {
		super(instance, 152);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			PsilocybinUsageProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
