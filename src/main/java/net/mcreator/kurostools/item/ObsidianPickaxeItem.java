...
public class ObsidianPickaxeItem extends KurosToolsModElements.ModElement {
	@ObjectHolder("kuros_tools:obsidian_pickaxe")
	public static final Item block = null;

	public ObsidianPickaxeItem(KurosToolsModElements instance) {
		super(instance, 6);
	}
