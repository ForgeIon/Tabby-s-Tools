...
public class CrushedGoldOreItem extends KurosToolsModElements.ModElement {
	@ObjectHolder("kuros_tools:crushed_gold_ore")
	public static final Item block = null;

	public CrushedGoldOreItem(KurosToolsModElements instance) {
		super(instance, 18);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("crushed_gold_ore");
		}
