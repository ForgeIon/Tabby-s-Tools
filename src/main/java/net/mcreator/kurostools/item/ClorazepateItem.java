...
public class ClorazepateItem extends KurosToolsModElements.ModElement {
	@ObjectHolder("kuros_tools:clorazepate")
	public static final Item block = null;

	public ClorazepateItem(KurosToolsModElements instance) {
		super(instance, 158);
	}
