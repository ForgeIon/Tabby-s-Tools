...
public class ObsidianAxeItem extends KurosToolsModElements.ModElement {
	@ObjectHolder("kuros_tools:obsidian_axe")
	public static final Item block = null;

	public ObsidianAxeItem(KurosToolsModElements instance) {
		super(instance, 7);
	}
