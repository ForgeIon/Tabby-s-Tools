...
import net.mcreator.kurostools.procedures.MethamphetamineUsageProcedure;
...
public class MethamphetamineItem extends KurosToolsModElements.ModElement {
	@ObjectHolder("kuros_tools:methamphetamine")
	public static final Item block = null;

	public MethamphetamineItem(KurosToolsModElements instance) {
		super(instance, 154);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("methamphetamine");
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			MethamphetamineUsageProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
