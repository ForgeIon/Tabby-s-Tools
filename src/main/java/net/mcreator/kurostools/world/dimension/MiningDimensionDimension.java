...
package net.mcreator.kurostools.world.dimension;
...
public class MiningDimensionDimension extends KurosToolsModElements.ModElement {
	public MiningDimensionDimension(KurosToolsModElements instance) {
		super(instance, 142);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("kuros_tools:mining_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
