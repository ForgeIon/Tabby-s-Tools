...
import net.mcreator.kurostools.procedures.SeparatorProcedProcedure;
...
public class SeparatorGuiGui extends KurosToolsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public SeparatorGuiGui(KurosToolsModElements instance) {
		super(instance, 2);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("separator_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, SeparatorGuiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 6, 34) {
				@Override
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 133, 16) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 133, 52) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				KurosToolsMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			SeparatorProcedProcedure.executeProcedure(Stream
