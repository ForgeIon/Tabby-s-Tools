...
public class ConveyorBeltEntityOnBlockProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				KurosToolsMod.LOGGER.warn("Failed to load dependency world for procedure ConveyorBeltEntityOnBlock!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				KurosToolsMod.LOGGER.warn("Failed to load dependency x for procedure ConveyorBeltEntityOnBlock!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				KurosToolsMod.LOGGER.warn("Failed to load dependency y for procedure ConveyorBeltEntityOnBlock!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				KurosToolsMod.LOGGER.warn("Failed to load dependency z for procedure ConveyorBeltEntityOnBlock!");
			return;
		}
		if (dependencies.get("blockstate") == null) {
			if (!dependencies.containsKey("blockstate"))
				KurosToolsMod.LOGGER.warn("Failed to load dependency blockstate for procedure ConveyorBeltEntityOnBlock!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				KurosToolsMod.LOGGER.warn("Failed to load dependency entity for procedure ConveyorBeltEntityOnBlock!");
			return;
		}
		...
		if (((world instanceof World) ? ((World) world).isBlockPowered(new BlockPos(x, y, z)) : false) == false) {
			if (Direction.NORTH == Direct) {
				entity.setMotion((entity.getMotion().getX()), (entity.getMotion().getY()), (entity.getMotion().getZ() + 0.22));
			} else if (Direction.SOUTH == Direct) {
				entity.setMotion((entity.getMotion().getX()), (entity.getMotion().getY()), (entity.getMotion().getZ() - 0.22));
			} else if (Direction.WEST == Direct) {
				entity.setMotion((entity.getMotion().getX() + 0.22), (entity.getMotion().getY()), (entity.getMotion().getZ()));
